...
function CompareImageCard(props) {
    ...
    const {productItemImage,productItemName,rating,specifications,numberOfRatings,numberOfReviews,price} = {...productItemDetails};
    ...
    return (
        <div className="product-image-compare-card">
            ...
            <p className='compare-product-price'>₹{price}</p>
        </div>
    )
}
